...
//    }
    ...
    fun testGetTvShowsList() {
        ...
        val tvShow = Resource.Success(PagedListUtil.mockPagedList(DataDummy.generateDummyListTvEntity()))
    ...
    fun testGetAllFavoriteTv() {
        ...
        val favoriteTv = Resource.Success(PagedListUtil.mockPagedList(DataDummy.generateDummyListTvEntity()))
